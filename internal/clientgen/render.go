...
func Render(modulePath string, schema []byte) (File, error) {
	...
	fmt.Fprintln(&source, "\thandle applicationinvocation.Handle")
	fmt.Fprintln(&source, "}")
	fmt.Fprintln(&source)
	fmt.Fprintln(&source, "// New binds a generated client to the canonical application invocation path.")
	fmt.Fprintln(&source, "func New(handle applicationinvocation.Handle) Client {")
	...
	fmt.Fprintln(&source, "\treturn applicationinvocation.Available(c.handle)")
	fmt.Fprintln(&source, "}")
	fmt.Fprintln(&source)
