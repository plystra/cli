...
func TestRunExplainCapabilityHelp(t *testing.T) {
	t.Parallel()
...
func TestRunRejectsUnknownCommandAndExtraArguments(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "explain unsupported subject kind", arguments: []string{"explain", "plugin", "acme.email"}, wantError: wantExplainCapabilityUsage},
