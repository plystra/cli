...
const (
	...
	wantGenerateUsageWithSources     = wantGenerateUsage + wantDiagnosticSourceUsage + wantProtobufIdentitySourceUsage + wantProtobufOperationSourceUsage
	wantCheckUsageWithSources        = wantCheckUsage + wantDiagnosticSourceUsage + wantProtobufIdentitySourceUsage + wantProtobufOperationSourceUsage
)
