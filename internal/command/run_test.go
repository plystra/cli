...
const (
	...
	wantGenerateUsageWithSources      = wantGenerateUsage + wantDiagnosticSourceUsage + wantProtobufIdentitySourceUsage + wantProtobufOperationSourceUsage + wantCapabilityManifestSourceUsage
	wantCheckUsageWithSources         = wantCheckUsage + wantDiagnosticSourceUsage + wantProtobufIdentitySourceUsage + wantProtobufOperationSourceUsage + wantCapabilityManifestSourceUsage
)
