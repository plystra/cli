...
const (
	...
	wantGenerateUsageWithSources          = wantGenerateUsage + wantDiagnosticSourceUsage + wantProtobufIdentitySourceUsage + wantProtobufOperationSourceUsage + wantCapabilityManifestSourceUsage + wantGenerationActivationSourceUsage + wantGenerationContributionSourceUsage + wantConcurrentSourceUsage
	wantCheckUsageWithSources             = wantCheckUsage + wantDiagnosticSourceUsage + wantProtobufIdentitySourceUsage + wantProtobufOperationSourceUsage + wantCapabilityManifestSourceUsage + wantGenerationActivationSourceUsage + wantGenerationContributionSourceUsage + wantConcurrentSourceUsage
)
