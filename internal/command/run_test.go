...
const (
	...
	wantGenerateUsageWithSources      = wantGenerateUsage + wantDiagnosticSourceUsage + wantProtobufIdentitySourceUsage + wantProtobufOperationSourceUsage + wantCapabilityManifestSourceUsage + wantConcurrentSourceUsage
	wantCheckUsageWithSources         = wantCheckUsage + wantDiagnosticSourceUsage + wantProtobufIdentitySourceUsage + wantProtobufOperationSourceUsage + wantCapabilityManifestSourceUsage + wantConcurrentSourceUsage
)
