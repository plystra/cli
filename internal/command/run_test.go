...
const (
	...
	wantGenerateUsageWithSources = wantGenerateUsage + wantDiagnosticSourceUsage
	wantCheckUsageWithSources    = wantCheckUsage + wantDiagnosticSourceUsage
)
