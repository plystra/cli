...
const (
	...
	wantGenerateUsageWithSources        = wantGenerateUsage + wantDiagnosticSourceUsage + wantProtobufIdentitySourceUsage + wantProtobufOperationSourceUsage + wantCapabilityManifestSourceUsage + wantGenerationActivationSourceUsage + wantConcurrentSourceUsage
	wantCheckUsageWithSources           = wantCheckUsage + wantDiagnosticSourceUsage + wantProtobufIdentitySourceUsage + wantProtobufOperationSourceUsage + wantCapabilityManifestSourceUsage + wantGenerationActivationSourceUsage + wantConcurrentSourceUsage
)
