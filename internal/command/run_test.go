...
const (
	...
	wantGenerateUsageWithSources    = wantGenerateUsage + wantDiagnosticSourceUsage + wantProtobufIdentitySourceUsage
	wantCheckUsageWithSources       = wantCheckUsage + wantDiagnosticSourceUsage + wantProtobufIdentitySourceUsage
)
