...
func Render(modulePath string, target CanonicalTargetView) (File, error) {
	...
	renderInvocationBoundary(&source, contract.Errors)
...
func renderServeHTTP(source *strings.Builder) {
...
func renderInvocationBoundary(source *strings.Builder, semanticErrors []string) {
