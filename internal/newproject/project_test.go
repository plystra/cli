...
func createKernelProxy(t *testing.T) string {
	...
	files := []struct {
		...
		{name: "interfaces/kernel/health/v1/interface.go", data: []byte("package healthv1\n\ntype Request struct{}\ntype Status string\nconst StatusHealthy Status = \"healthy\"\ntype Response struct { Status Status `json:\"status\"` }\n")},
		{name: "interfaces/kernel/info/v1/interface.go", data: []byte("package infov1\n\ntype Request struct{}\ntype Response struct { AssemblyAPI string `json:\"assembly_api\"`; KernelModule string `json:\"kernel_module\"`; KernelVersion string `json:\"kernel_version\"` }\n")},
