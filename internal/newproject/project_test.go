...
func assertReadmeUsesAvailableCommands(t *testing.T, readme []byte) {
	...
	for _, wireHistory := range [][]byte{
		...
		[]byte("request, response, and reachable same-package messages"),
		[]byte("exact stable service, method, and Connect procedure identity"),
		[]byte("Authored positive `plystra` field numbers are the wire numbers"),
		[]byte("Generation rejects renumbering"),
		[]byte("permanently reserves every removed Protobuf field name and number"),
		[]byte("retains inactive Interface and message history"),
...
func assertPlystraSkill(t *testing.T, root, modulePath string) {
	...
	for _, required := range []string{
		...
		"generated/compatibility/interfaces.json and interface-metadata.json",
		"CLI-owned baselines",
		"Run plystra generate to update them",
		...
		"response, and reachable same-package messages",
		"exact stable service",
		"method, and Connect procedure identity",
		"Authored positive plystra field",
		"numbers are the wire numbers",
		"Generation rejects renumbering",
		"reserves every removed Protobuf field name and number",
		"retains inactive",
		"Interface and message history",
