...
The current Go Module path is example.com/acme/email. Read its go.mod before writing imports.
...
provider interface in the Plugin-owned scaffold:
    ...
    import (
        ...
        contract "example.com/acme/email/generated/go/contracts/records/read/v1"
    )
...
set and retain the generated client:
    ...
    import (
        ...
        lookupcontract "example.com/acme/email/generated/go/contracts/catalog/lookup/v1"
        ordercontract "example.com/acme/email/generated/go/contracts/order/place/v1"
        dependencies "example.com/acme/email/generated/go/dependencies/orders"
    )
